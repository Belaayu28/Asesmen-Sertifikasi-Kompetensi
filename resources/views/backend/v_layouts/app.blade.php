...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ asset('backend/img/bela-img.jpg') }}" alt="Profile" class="rounded-circle">
                        <span class="d-none d-md-block dropdown-toggle ps-2">Bela Ayu.S</span>
                    </a><!-- End Profile Iamge Icon -->

                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6>Bela Ayu Setyawati</h6>
                            <span>Mahasiswa</span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="admins-profile.html">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('assessments.index') }}">
                    <i class="bi bi-grid"></i>
